...
# =============================================================================
log_step "Building Binutils-2.44 (Pass 2)..."
cd $LFS/sources
...
log_info "Binutils-2.44 (Pass 2) completed"

# =============================================================================
# Package 2: GCC (Pass 2)
# =============================================================================
log_step "Building GCC-14.2.0 (Pass 2)..."
cd $LFS/sources
...
log_info "GCC-14.2.0 (Pass 2) completed"

# =============================================================================
# Package 3: Linux API Headers
# =============================================================================
log_step "Building Linux-6.12 API Headers (Final)..."
cd $LFS/sources
...
# =============================================================================
log_step "Building Glibc-2.41 (Final)..."
cd $LFS/sources
...
make DESTDIR=$LFS install
cd $LFS/sources && rm -rf perl-5.40.0
log_info "Perl completed"

# =============================================================================
# Package 24: Python
# =============================================================================
log_step "Building Python-3.12.7..."
cd $LFS/sources
...
make -j$(nproc)
make DESTDIR=$LFS install
cd $LFS/sources && rm -rf Python-3.12.7
log_info "Python completed"

# =============================================================================
# Package 25: Vim
# =============================================================================
log_step "Building Vim-9.1..."
cd $LFS/sources
tar -xf vim-9.1.0937.tar.gz
cd vim-9.1.0937
...
set encoding=utf-8
EOF
cd $LFS/sources && rm -rf vim-9.1.0937
